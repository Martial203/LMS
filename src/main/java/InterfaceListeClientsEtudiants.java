 ...
 * @author MARTIAL
 */
public class InterfaceListeClientsEtudiants extends javax.swing.JFrame {
                ...
                try{
                    ...
                    if(result.next()){
                        ...
                        if(validationPret!=null){
                            if(validationPret.equals(tableEtudiants.getValueAt(tableEtudiants.getSelectedRow(), 0))){
                                ...
                                JOptionPane.showMessageDialog(editorComponent, "Le matricule que vous venez d'entrer ne correspond pas à celui avec lequel a été initiée la demande. Veuillez ressayer !");
                            }
                        }
                    }
                    else{
    ...
    public InterfaceListeClientsEtudiants(String filiere, int lang) {
        initComponents();
        langue = lang;
        ...
        optionCeClientNe = new String[2];
            ...
            optionCeClientNe[1] = "This customer cannot benefit from the libraey services. \n Reason : Debt of ";
        optionDateEmprun = new String[2];
            optionDateEmprun[0] = "Demande d'emprunt de l'article aux caractéristiques suivantes : \n Titre: ";
            optionDateEmprun[1] = "Borrowing request for the item with the following characteristics : \n Title: ";
        ...
        optionEntrerEmplac = new String[2];
            ...
            optionEntrerEmplac[1] = "Please enter the location of the item you want to lend.";
        optionPlusDeQuatreArti = new String[2];
            ...
            optionPlusDeQuatreArti[1] = "This customer already has 04 items in his possession, he cannot borrows more !";
        optionPourValider = new String[2];
            optionPlusDeQuatreArti[0] = "\n\n Pour valider le prêt, veuillez entrer le matricule du client";
            optionPlusDeQuatreArti[1] = "\n\n To confirm the loan, please enter the customer's matricule";
        optionAucunArticle = new String[2];
            ...
            optionAucunArticle[1] = "No items is associated with the designated location. Please try again !";
        try{
            int nbreElements;
            ...
            if((filiere.equals(""))){
                result = statement.executeQuery("SELECT COUNT(*) as nbreElements FROM clients WHERE Categorie='Etudiant' AND Filiere='Création et Design Numérique' AND Date_suppression IS NULL");
                result.next();
                nbreElements=result.getInt("nbreElements");
                result = statement.executeQuery("SELECT * FROM clients WHERE Categorie='Etudiant' AND Filiere='Création et Design Numérique' AND Date_suppression IS NULL ORDER BY Noms");
            }else{
                if(filiere.equals("Création et Design Numérique")){
                    toogleCDN.setSelected(true);
                    toogleISN.setSelected(false);
                    toogleINS.setSelected(false);
                }
                else if(filiere.equals("Ingenierie Numérique Sociotechnique")){
                    toogleCDN.setSelected(false);
                    toogleINS.setSelected(true);
                    toogleISN.setSelected(false);
                }
                else{
                    toogleCDN.setSelected(false);
                    toogleINS.setSelected(false);
                    toogleISN.setSelected(true);
                }
                result = statement.executeQuery("SELECT COUNT(*) as nbreElements FROM clients WHERE Categorie='Etudiant' AND Filiere='"+filiere+"' AND Date_suppression IS NULL");
                result.next();
                nbreElements=result.getInt("nbreElements");
                result = statement.executeQuery("SELECT * FROM clients WHERE Categorie='Etudiant' AND Filiere='"+filiere+"' AND Date_suppression IS NULL ORDER BY Noms");
            }
                this.tabInfosEtudiants = new Object [7];
                DefaultTableModel tabInformations = (DefaultTableModel)tableEtudiants.getModel();
                tableEtudiants.getColumnModel().getColumn(6).setCellRenderer(new ButtonRenderer());
                tableEtudiants.getColumnModel().getColumn(6).setCellEditor(new ButtonEditor(new JCheckBox()));
                while(result.next()){
                    tabInfosEtudiants[0]=result.getString("Matricule");
                    tabInfosEtudiants[1]=result.getString("Noms");
                    tabInfosEtudiants[2]=result.getString("Prenoms");
                    tabInfosEtudiants[3]=result.getString("Sexe");
                    tabInfosEtudiants[4]=result.getInt("Niveau");
                    tabInfosEtudiants[5]=result.getString("Adresse_Mail");
                    tabInfosEtudiants[6]="OK";
                    tabInformations.addRow(tabInfosEtudiants);
                }
        }catch(Exception e){
            e.printStackTrace();
        }
    ...
    private void initComponents() {
        ...
        getContentPane().add(toogleListeClients, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 100, 110, -1));
        ...
        getContentPane().add(toogleAjoutClient, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 160, -1, -1));
        ...
        getContentPane().add(recherche, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 10, 109, -1));
        ...
        getContentPane().add(searchIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 10, -1, -1));

        lblTri.setText("Trier par :");
        getContentPane().add(lblTri, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 10, -1, -1));

        comboTri.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "", "Matricule", "Niveau" }));
        ...
        getContentPane().add(comboTri, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 10, 77, -1));
        ...
        getContentPane().add(toogleEnseignants, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 50, 110, -1));
        ...
        getContentPane().add(toogleISN, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 50, 70, -1));
        ...
        getContentPane().add(toogleINS, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 50, 70, -1));
        ...
        getContentPane().add(toogleCDN, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 50, 70, -1));
        ...
        tableEtudiants.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Matricule", "Noms", "Prénoms", "Sexe", "Niveau", "Adresse mail", "Faire un prêt"
            }
        ) {
        ...
        jScrollPane3.setViewportView(tableEtudiants);

        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 90, 480, 353));
    ...
    private void toogleISNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_toogleISNActionPerformed
        ...
        if(toogleISN.isSelected()){
            ...
            try{
                result = statement.executeQuery("SELECT * FROM clients WHERE Categorie='Etudiant' AND Filiere='Ingenierie des Systèmes Numériques' AND Date_suppression IS NULL ORDER BY Noms");
                this.tabInfosEtudiants = new Object [7];
                DefaultTableModel tabInformations = (DefaultTableModel)tableEtudiants.getModel();
    ...
    private void toogleEnseignantsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_toogleEnseignantsActionPerformed
        ...
        if(toogleEnseignants.isSelected()){
            ...
            toogleISN.setSelected(false);
            toogleCDN.setSelected(false);
            InterfaceListeClientsEnseignants interfaceListeEnseignants = new InterfaceListeClientsEnseignants(langue);
            interfaceListeEnseignants.setVisible(true);
            this.dispose();
        }
    ...
    private void toogleINSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_toogleINSActionPerformed
        ...
        if(toogleINS.isSelected()){
            ...
            toogleEnseignants.setSelected(false);
            try{
                result = statement.executeQuery("SELECT * FROM clients WHERE Categorie='Etudiant' AND Filiere='Ingenierie Numérique Sociotechnique' AND Date_suppression IS NULL ORDER BY Noms");
                this.tabInfosEtudiants = new Object [7];
                DefaultTableModel tabInformations = (DefaultTableModel)tableEtudiants.getModel();
                for(int i=tabInformations.getRowCount()-1; i>=0; i--){
                    tabInformations.removeRow(i);
    ...
    private void searchIconMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchIconMouseClicked
        ...
        try{
            ...
            statement = connection.createStatement();
            try{
                int Lv = Integer.parseInt(recherche.getText());
                result = statement.executeQuery("SELECT * FROM clients WHERE (Categorie='"+recherche.getText()+"' OR Noms LIKE'%"+recherche.getText()+"%' OR Prenoms LIKE '%"+recherche.getText()+"%' OR Sexe LIKE '"+recherche.getText()+"%' OR Adresse_mail LIKE '%"+recherche.getText()+"%' OR Niveau="+Lv+") AND Date_suppression IS NULL ORDER BY Noms");
            }catch(Exception e){
                ...
                while(result.next()){
                    ...
                    tabInfosEtudiants[2]=result.getString("Prenoms");
                    tabInfosEtudiants[3]=result.getString("Sexe");
                    tabInfosEtudiants[4]=result.getString("Niveau");
                    tabInfosEtudiants[5]=result.getString("Adresse_Mail");
                    tabInfosEtudiants[6]="OK";
                    tabInformations.addRow(tabInfosEtudiants);
                    compteur++;
    ...
    private void comboTriItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comboTriItemStateChanged
        ...
        if(((String)comboTri.getSelectedItem()).equals("")){
            ...
            if(toogleCDN.isSelected()){
                try{
                    result = statement.executeQuery("SELECT * FROM clients WHERE Categorie='Etudiant' AND Filiere='Création et Design Numérique' AND Date_suppression IS NULL ORDER BY "+(String)comboTri.getSelectedItem()+", Noms");
                }catch(Exception e){
                    e.printStackTrace();
                }
            }
                ...
                try{
                    result = statement.executeQuery("SELECT * FROM clients WHERE Categorie='Etudiant' AND Filiere='Ingenierie Numérique Sociotechnique' AND Date_suppression IS NULL ORDER BY "+(String)comboTri.getSelectedItem()+", Noms");
                }catch(Exception e){
                    e.printStackTrace();
                }
        }
                ...
                try{
                    result = statement.executeQuery("SELECT * FROM clients WHERE Categorie='Etudiant' AND Filiere='Ingenierie des Systèmes Numériques' AND Date_suppression IS NULL ORDER BY "+(String)comboTri.getSelectedItem()+", Noms");
                }catch(Exception e){
                    e.printStackTrace();
                }
        }
            ...
            try{
                int Lv = Integer.parseInt(recherche.getText());
                result = statement.executeQuery("SELECT * FROM clients WHERE (Categorie='"+recherche.getText()+"' OR Noms LIKE'%"+recherche.getText()+"%' OR Prenoms LIKE '%"+recherche.getText()+"%' OR Sexe LIKE '"+recherche.getText()+"%' OR Adresse_mail LIKE '%"+recherche.getText()+"%' OR Niveau="+Lv+") AND Date_suppression IS NULL ORDER BY "+(String)comboTri.getSelectedItem()+", Noms");
            }catch(Exception e){
                try{
                    result = statement.executeQuery("SELECT * FROM clients WHERE (Categorie='"+recherche.getText()+"' OR Noms LIKE'%"+recherche.getText()+"%' OR Prenoms LIKE '%"+recherche.getText()+"%' OR Sexe LIKE '"+recherche.getText()+"%' OR Adresse_mail LIKE '%"+recherche.getText()+"%') AND Date_suppression IS NULL ORDER BY "+(String)comboTri.getSelectedItem()+", Noms");
                }catch(Exception ex){
                    ex.printStackTrace();
                }
            }
    ...
    private Object tabInfosEtudiants[];
